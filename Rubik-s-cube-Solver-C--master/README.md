...
### Visual Studio
1. Open the solution file [AI1.sln](file:///c:/Users/bhupe/OneDrive/Desktop/Rubik-s-cube-Solver-C--master/AI1.sln) in Visual Studio.
2. Build and run the project (the project configuration is updated to target C++latest/C++23).
